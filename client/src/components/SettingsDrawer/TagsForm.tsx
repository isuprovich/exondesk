...
import { Grid, TextField, Button, Typography, ButtonGroup, Paper, Collapse } from '@material-ui/core';
    ...
    return <Paper variant="outlined">
        <form onSubmit={handleSubmit(saveTag)}>
            <Grid container direction="column" spacing={2} style={{ padding: '16px' }}>
                <Grid item xs={12}>
                <Button fullWidth={true} onClick={() => setExpanded(!expanded)}><Typography align="center" variant="subtitle2">{tagsLabel}</Typography></Button>
                </Grid>
